...
rollButton1.addEventListener("click",function() {
    switch(randomNum) {
        case 1:
            p1Dice.src = "assets/1.png";
            p1Dice.style.display = "block";
            break;
        case 2:
            p1Dice.src = "assets/2.png";
            p1Dice.style.display = "block";
            break;
        case 3:
            p1Dice.src = "assets/3.png";
            p1Dice.style.display = "block";
            break;
        case 4:
            p1Dice.src = "assets/4.png";
            p1Dice.style.display = "block";
            break;
        case 5:
            p1Dice.src = "assets/5.png";
            p1Dice.style.display = "block";
            break;
        case 6:
            p1Dice.src = "assets/6.png";
            p1Dice.style.display = "block";
            break;
        default:
...
rollButton2.addEventListener("click",function() {
    switch(randomNum) {
        case 1:
            p2Dice.src = "assets/1.png";
            p2Dice.style.display = "block";
            break;
        case 2:
            p2Dice.src = "assets/2.png";
            p2Dice.style.display = "block";
            break;
        case 3:
            p2Dice.src = "assets/3.png";
            p2Dice.style.display = "block";
            break;
        case 4:
            p2Dice.src = "assets/4.png";
            p2Dice.style.display = "block";
            break;
        case 5:
            p2Dice.src = "assets/5.png";
            p2Dice.style.display = "block";
            break;
        case 6:
            p2Dice.src = "assets/6.png";
            p2Dice.style.display = "block";
            break;
        default:
